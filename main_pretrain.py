...
def main(args):
    ...
    # define the model
    model = mcm_model.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, args=args)
    ...
    trainable_params.mark_only_MCM_as_trainable(model)
